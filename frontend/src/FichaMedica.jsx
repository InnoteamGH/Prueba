        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "15px 22px", background: "var(--dc-white)", borderBottom: `1px solid ${SOFT}` }}>
          <div style={{ display: "flex", alignItems: "center", gap: 11 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 16, fontWeight: 500, color: NAVY, fontFamily: "'Geist Variable', 'Geist', system-ui, sans-serif", lineHeight: 1.1 }}>{p.nombre || "Ficha médica"}</div>
            ...
            <div style={{ background: "var(--dc-bg)", borderRadius: "var(--dc-r-lg)", padding: "13px 15px", display: "grid", gap: 7 }}>
              {[
                ...
                <div key={l} style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", fontSize: 13 }}>
                  ...
                  <b style={{ color: c, fontSize: 14, fontFamily: "'Geist Variable', 'Geist', system-ui, sans-serif" }}>{v}</b>
                </div>
              ))}
            </div>
